...
public:
	...
	bool intersectWith(const line2d!(T) l, ref vector2!T vout) const
	{
		...
		if(cgy.stolen.math.equals(commonDenominator, 0.0f))
		{ 
			// The lines are either coincident or parallel
			// if both numerators are 0, the lines are coincident
			if(cgy.stolen.math.equals(numeratorA, 0.0f) && cgy.stolen.math.equals(numeratorB, 0.0f))
			{
