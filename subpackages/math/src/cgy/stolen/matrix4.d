module cgy.stolen.matrix4;

import core.stdc.string : memset, memcpy;

import cgy.math.vector;

import cgy.stolen.plane3d;
...
struct CMatrix4(T)
{
  public:
    ...
    {
      if (!cgy.stolen.math.equals( M[ 0], cast(T)1 ) ||
          !cgy.stolen.math.equals( M[ 5], cast(T)1 ) ||
          !cgy.stolen.math.equals( M[10], cast(T)1 ) ||
          !cgy.stolen.math.equals( M[15], cast(T)1 ))
        return false;
...
*/        
    ...
    */
    ...
    {
      for (int i; i < 16; ++i)
        if (!cgy.stolen.math.equals(M[i], other.M[i], tolerance))
          return false;
