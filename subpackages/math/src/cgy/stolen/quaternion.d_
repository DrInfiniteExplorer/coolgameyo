...
module cgy.stolen.quaternion;

import std.conv;

import cgy.math.vector;
import cgy.stolen.matrix4;
...
public:
	...
	{
		return cgy.stolen.math.equals(X, other.X, tolerance) &&
            cgy.stolen.math.equals(Y, other.Y, tolerance) &&
            cgy.stolen.math.equals(Z, other.Z, tolerance) &&
            cgy.stolen.math.equals(W, other.W, tolerance);			
	}
